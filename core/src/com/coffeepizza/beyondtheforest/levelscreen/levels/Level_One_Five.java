...
public class Level_One_Five extends LevelScript {

    // System
    private boolean debugging = false;
    private String tag = "Lvl_15";
    private String message = "";

    // Manager
    private LevelScreen screen;

    public Level_One_Five(BeyondManager manager, LevelScreen screen) {
