...
public class InGameSettingsScreen implements Screen {

    // System
    private boolean debugging = false;
    private String tag = "InGameSettings";
    ...
    private boolean returningToALevel;
    ...
    public InGameSettingsScreen(BeyondManager parent, LevelScreen screen) {
        ...
        prefs = parent.prefs;
        returningToALevel = true;
    }

    public InGameSettingsScreen(BeyondManager parent) {//, OverworldScreen screen) {
        this.manager = parent;
        //this.overWorldScreen = screen;
        this.spriteBatch = parent.spriteBatch;
        this.shapeRenderer = parent.shapeRenderer;
        this.ostManager = parent.ostManager;
        textureAtlas = parent.getAtlas();
        prefs = parent.prefs;
        returningToALevel = false;
    }
    ...
    private void loadAssets() {
        ...
        mainMenuButtonDrawable = new TextureRegionDrawable(textureAtlas.findRegion("setting_menu_main_menu_return"));
        ...
        backStyle = new ImageButton.ImageButtonStyle(backButtonDrawable, null, null,
                null, null, null);
        mainMenuStyle = new ImageButton.ImageButtonStyle(mainMenuButtonDrawable, null, null,
                null, null, null);
    ...
    private void configureButtonListeners() {
        ...
        */
        ...
        mainMenuButton.addListener(new ChangeListener() {
            public void changed (ChangeEvent event, Actor actor) {
                manager.sendDebugMsg(debugging, tag,"Hit main menu button");
        ...
        backButton.addListener(new ChangeListener() {
            public void changed (ChangeEvent event, Actor actor) {
                ...
                if (returningToALevel) {
                    manager.setPreviouslyLoadedLevel(levelScreen);
                } else {
    ...
    private void mobileTableSetup() {
        ...
        */
        ...
        previewsTable.row();
        previewsTable.add(mainMenuButton).size((mainMenuButtonDrawable.getRegion().getRegionWidth() * buttonHeight) / mainMenuButtonDrawable.getRegion().getRegionHeight(),
                        buttonHeight)
                //.colspan(3)
                //.padBottom(edgePadding)
                .expandX();
        previewsTable.add().width(rowPadding * 5);
        ...
        previewsTable.row();
        previewsTable.add().height(edgePadding);
